...
import { 
  ArrowLeft, Target, Award, TrendingUp, 
  MessageSquare, User, ThumbsUp 
} from "lucide-react";

// --- MOCK DATA (Fuera del componente para evitar re-creación) ---
const PUBLIC_COMMENTS = [
  { id: 1, author: "Carlos Mendoza", comment: "¡Excelente proyecto!", timestamp: "Hace 2 horas", likes: 12 },
  { id: 2, author: "Ana Rodríguez", comment: "Muy innovador el enfoque.", timestamp: "Hace 4 horas", likes: 8 },
  { id: 3, author: "Luis Fernández", comment: "Gran trabajo en equipo.", timestamp: "Hace 5 horas", likes: 15 },
];
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <article className="bg-white rounded-lg shadow p-6 text-center">
            ...
            <div className="text-5xl font-bold text-purple-600 mb-2">{state.overallScore}</div>
            <p className="text-gray-600">de 100 puntos</p>
            <span className="inline-block mt-4 bg-purple-600 text-white px-3 py-1 rounded-full text-sm">Top 10%</span>
          </article>
        </section>
        ...
        <section className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-sm text-gray-600 mb-6">Lo que el público opina sobre tu proyecto</p>
          <div className="space-y-4">
            {PUBLIC_COMMENTS.map(comment => (
