 ...
 */
function formatDateRange(fechaIni, fechaFin) {
 ...
 * 
 * Props basados en el schema de la BD:
 * @param {Object} props
 * @param {number} props.id
 * @param {string} props.nombre
 * @param {string} [props.descripcion]
 * @param {string} props.fechaIni - ISO date
 * @param {string} props.fechaFin - ISO date
 * @param {string} props.estado - "Configuracion" | "Abierto" | "EnCurso" | "Finalizado"
 * @param {string} props.rol - "Organizador" | "Participante" | "Jurado" | "Publico"
 * @param {Function} [props.onClick]
 */
export function EventCard({ nombre, descripcion, fechaIni, fechaFin, estado, rol, onClick }) {
